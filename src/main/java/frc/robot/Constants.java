...
public class Constants {
    ...
    static ChassisSpeeds robotVelocity;
        ...
        public static class SPINDEXER_MOTOR_CONFIGS {
            ...
            public static final double SPINDEXER_MOTOR_SPEED = 16;
            public static final double SLOT_0_kS = 0;
            public static final double SLOT_0_kV = 0.118;
            public static final double SLOT_0_kA = 0;
        ...
        public static class SHOOTING_CONSTANTS {
            ...
            private static InterpolatingDoubleTreeMap createShuttleLookup() {
                var map = new InterpolatingDoubleTreeMap();
                map.put(Units.inchesToMeters(60), 60.0); 
                map.put(Units.inchesToMeters(216), 85.0);
                return map;
            }
            ...
            private static  InterpolatingDoubleTreeMap createLatencyLookup(){
                var map = new InterpolatingDoubleTreeMap();
                map.put((.5),(9.0));
                map.put((1.0),(12.0));
            ...
            public static final InterpolatingDoubleTreeMap LATENCY_LOOKUP_TABLE = createLatencyLookup();
